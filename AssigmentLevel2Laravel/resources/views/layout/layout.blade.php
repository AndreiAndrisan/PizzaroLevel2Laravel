...
<html lang="en-US">
   <head>
      ...
      <link rel="stylesheet" type="text/css" href="{{ URL::asset('css/animate.min.css') }}" media="all" />
      <link rel="stylesheet" type="text/css" href="{{ URL::asset('css/font-pizzaro.css') }}" media="all" />
      <link rel="stylesheet" type="text/css" href="{{ URL::asset('css/style.css') }}" media="all" />
      <link rel="stylesheet" type="text/css" href="{{ URL::asset('css/colors/red.css') }}" media="all" />
      <link rel="stylesheet" type="text/css" href="{{ URL::asset('css/jquery.mCustomScrollbar.min.css') }}" media="all" />      
      <link href="https://fonts.googleapis.com/css?family=Open+Sans:300,400,600,700,800%7CYanone+Kaffeesatz:200,300,400,700" rel="stylesheet">
      <link rel="shortcut icon" href="{{ URL::asset('images/fav-icon.png') }}">
   </head>
   <body class="full-width grid-view columns-3 archive woocommerce-page single-product style-1 woocommerce woocommerce-cart">
      <div id="page" class="hfeed site">
        <div class="container">
          <!-- Trigger the modal with a button -->
          <button type="button" id="modalTrigger" class="btn btn-info btn-lg hidden" data-toggle="modal" data-target="#myModal">Open Modal</button>
          <!-- Modal -->
            ...
            <div class="modal-dialog modal-dialog-centered">
              ...
              <div class="modal-content">
                <div class="modal-header">
                  ...
                  <h4 class="modal-title" style="color: white">Session Expired</h4>
                </div>
         ...
         <header id="masthead" class="site-header header-v1"  style="background-image: none; ">
            <div class="col-full">
               ...
               <div class="header-wrap row">
                   ...
                   <!-- #site-navigation -->
                   <div class="header-info-wrapper col-xs-10 row">
                      <div class="header-phone-numbers col-xs-4">
                         <span class="intro-text">Call and Order in</span>
                         <select class="select-city-phone-numbers" name="city-phone-numbers" id="city-phone-numbers">
                            <option value="+44 4548 779 654">London</option>
                            <option value="+33 3398 621 710">Paris</option>
                            <option value="+35 1854 674 021">New York</option>
                         </select>
                         <a href="tel:+444548779654" id="city-phone-number-label" class="phone-number" rel="nofollow">+44 4548 779 654</a>
                      </div>
                      <ul class="site-header-cart-v2 menu col-xs-4 text-right">
                         <li class="cart-content ">
                            ...
                            <ul class="sub-menu">
                               <li>
                                  <a href="{{url('cart')}}" title="View your shopping cart">
                                  <span id="count-header" class="count">{{(count(session()->get('cart', []))) ? count(session()->get('cart', [])) : 0}} items</span> <span id="amount-header" class="amount">${{(session()->get('price')) ? session()->get('price') : 0}}</span>
                                  </a>
                               </li>
                            </ul>
                         </li>
               ...
               <nav class="navbar-inverse">
	                <div class="navbar-header">
		                <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".secondary-navigation">
                  ...
                  <nav class="secondary-navigation"  aria-label="Secondary Navigation">
                     <ul  class="menu">
                        @foreach($categories as $category)
                              <li class="menu-item"><a href="{{url($category->nume)}}"><i class="{{$category->clasa}}"></i>{{$category->nume}}</a></li>                      
                        @endforeach
                     </ul>
                  </nav>
...
@yield('content')
 ...
 <footer id="colophon" class="site-footer footer-v1" >
            <div class="col-full">
               ...
               <div class="site-info">
                  <p class="copyright">Copyright &copy; {{ date("Y")}} Pizzaro Template. All rights reserved.</p>
               </div>
               <!-- .site-info -->  
               <div class="pizzaro-handheld-footer-bar">
                  <ul class="columns-1">
                     <li class="cart">
                        ...
                        <span class="count">{{count(session()->get('cart', [])) ? count(session()->get('cart', [])) : 0 }}</span>
                        </a>
                     </li>
                  </ul>
               </div>
      ...
      <script type="text/javascript" src="{{ URL::asset('js/social.share.min.js') }}"></script>
      ...
      <script type="text/javascript" src="{{ URL::asset('js/ajax.js') }}" async></script>
      <!-- <script type="text/javascript" src="{{ URL::asset('js/jquey.jscroll.js') }}" async></script> -->
   </body>
</html>